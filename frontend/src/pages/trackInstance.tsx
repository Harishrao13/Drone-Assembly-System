            ...
            <div className="home flex flex-col space-y-12">
                ...
                <div className="flex justify-start text-left">
                    <div className="flex flex-col space-y-4 mx-0">
                        ...
                        <Label htmlFor="assembledBy" className="text-lg font-semibold">Assembled By: {/* Add the assembledBy field when available */}</Label>
                        <Label htmlFor="assembledOn" className="text-lg font-semibold">Assembled On: {data.assembledOn}</Label>
                        <Label htmlFor="progress" className="text-lg font-semibold capitalize">Progress: {data.progress}</Label>
